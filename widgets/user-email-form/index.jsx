        ...
        <div className="MuiPaper-root">
            <Paper sx={{ padding: '32px' }}>
                <Box component="section" sx={{ padding: '16px' }}>
                    ...
                    <Typography variant="p" sx={{marginBottom: '10px', color: 'rgb(121, 122, 122)'}}>
                        <span>
                            Please read our{' '}
                            <a style={{color: "rgb(107, 155, 237)"}} target="_blank" href="https://google.com">terms of use</a> to be
                            ...
                            <Grid2 alignContent="center">
                                <Typography>
                                    <span>
                                        ...
                                        <a style={{color: "rgb(107, 155, 237)"}} target="_blank" href="https://google.com">
                                            billing information.
                                        </a>
                                    </span>
                                </Typography>
